...
class Presensi_model extends CI_Model
{
    ...
    function get_all_query($id)
    {
        ...
        $sql = "SELECT a.id_absen,b.id_karyawan,b.nama_karyawan,a.tgl,a.jam_msk,a.jam_klr,c.nama_khd,a.ket,d.nama_status,d.id_status,a.img
    ...
    {
        $this->datatables->select('a.id_absen,b.id_karyawan,b.nama_karyawan,a.tgl,a.jam_msk,a.jam_klr,c.id_khd,c.nama_khd,a.ket,d.nama_status,d.id_status,a.img')
