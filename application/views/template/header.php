<header class="main-header">
    ...
    <a href="#" class="logo">
        ...
        <span class="logo-lg"><b>Sistem Absensi</b></span>
    </a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo base_url() ?>assets/dist/img/admin_antz.jpg" class="user-image" alt="User Image">
                        <span class="hidden-xs">Welcome, <?= $user->first_name ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="<?php echo base_url() ?>assets/dist/img/admin_antz.jpg" class="img-circle" alt="User Image">
                            <p>
