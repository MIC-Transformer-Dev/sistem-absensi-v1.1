                ...
                <div class="box-body">
                    <form role="form" id="myForm" data-toggle="validator" action="<?php echo $action; ?>" method="post">
                        <div class="form-group has-feedback">
                            <label for="nama_shift" class="label-control">Jam Kerja <?php echo form_error('nama_shift') ?></label>
                            <div class="input-group">
                                <input type="text" class="form-control" data-error="Jam Kerja harus diisi" name="nama_shift" id="nama_shift" placeholder="Jam Kerja" value="<?php echo $nama_shift; ?>" required />
