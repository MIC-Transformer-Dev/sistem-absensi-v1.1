                ...
                <div class="box-body">
                    <form role="form" id="myForm" data-toggle="validator" action="<?php echo $action; ?>" method="post">
                        <div class="form-group has-feedback">
                            <label for="nama_jabatan"> Nama Divisi <?php echo form_error('nama_jabatan') ?></label>
                            <div class="input-group">
                                <input type="text" class="form-control" data-error="Nama Divisi harus diisi" name="nama_jabatan" id="nama_jabatan" placeholder="Nama Divisi" value="<?php echo $nama_jabatan; ?>" required />
