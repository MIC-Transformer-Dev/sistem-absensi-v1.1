                    ...
                    <form role="form" id="myForm" data-toggle="validator" action="<?php echo $action; ?>" method="post">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="nama_karyawan" id="nama_karyawan" data-error="Nama Karyawan harus diisi" placeholder="Nama Karyawan" value="<?php echo $nama_karyawan; ?>" required />
                        ...
                        <div class="form-group">
                            <label for="jabatan" class="control-label">Divisi<?php echo form_error('jabatan') ?></label>
                            <div class="input-group">
                        ...
                        <div class="form-group">
                            <label for="id_shift" class="control-label">Jam Kerja<?php echo form_error('shfit') ?></label>
                            <div class="input-group">
