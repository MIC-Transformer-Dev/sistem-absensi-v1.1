                    ...
                    <form role="form" id="myForm" data-toggle="validator" action="<?php echo $action; ?>" method="post">
                        <div class="form-group has-feedback">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" data-error="Nama Lokasi harus diisi" name="nama_gedung" id="nama_gedung" placeholder="Nama Lokasi" value="<?php echo $nama_gedung; ?>" required />
